import "../../assets/Styles/Home/LabellingMachines.css"
...
export default function LabelingMachine() {
            ...
            <div className="best-seller-section">
                <div className="container">
                    <div className="text-center mb-4">
                        <h2 className="section-title">Labelling Machines</h2>
                        <p className="section-subtitle">Top brands and Related Category</p>
                    </div>
                    <div id="labellingMachineCarousel" className="carousel slide" data-bs-ride="carousel">
                            ...
                            <div className="carousel-item active">
                                <div className="row justify-content-center">
                                    <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
                                        <div className="product-card">
                                            <div className="product-image">
                                                <img src={img1} alt="Labelling Machine" />
                                            </div>
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
                                        <div className="product-card">
                                            <div className="product-image">
                                                <img src={img2} alt="Labelling Machine" />
                                            </div>
                                            <div className="product-info">
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
                                        <div className="product-card">
                                            <div className="product-image">
                                                <img src={img3} alt="Labelling Machine" />
                                            </div>
                                            <div className="product-info">
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
                                        <div className="product-card">
                                            <div className="product-image">
                                                <img src={img4} alt="Labelling Machine" />
                                            </div>
                                            <div className="product-info">
                            ...
                            <div className="carousel-item">
                                <div className="row justify-content-center">
                                    <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
                                        <div className="product-card">
                                            <div className="product-image">
                                                <img src={img5} alt="Labelling Machine" />
                                            </div>
                                            <div className="product-info">
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
                                        <div className="product-card">
                                            <div className="product-image">
                                                <img src={img6} alt="Labelling Machine" />
                                            </div>
                                            <div className="product-info">
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
                                        <div className="product-card">
                                            <div className="product-image">
                                                <img src={img7} alt="Labelling Machine" />
                                            </div>
                                            <div className="product-info">
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
                                        <div className="product-card">
                                            <div className="product-image">
                                                <img src={img8} alt="Labelling Machine" />
                                            </div>
                                            <div className="product-info">
                        ...
                        {/* Controls */}
                        <button className="carousel-control-prev" type="button" data-bs-target="#labellingMachineCarousel" data-bs-slide="prev">
                            <span className="carousel-control-prev-icon" />
                        </button>
                        <button className="carousel-control-next" type="button" data-bs-target="#labellingMachineCarousel" data-bs-slide="next">
                        ...
                        <div className="carousel-indicators">
                            <button type="button" data-bs-target="#labellingMachineCarousel" data-bs-slide-to={0} className="active" />
                            <button type="button" data-bs-target="#labellingMachineCarousel" data-bs-slide-to={1} />
                        </div>
                    </div>
